...
class Source(ABC):
	...
	\textbf{PM$_{2.5}$} stands apart. It is the only pollutant whose annual mean exceeds the limit in \emph{all} three urbanization categories, uniformly. That alone sets it apart from the rest and argues for region-wide structural measures rather than city-level fixes.
	 ...
	 Pollutants patterns vary across urbanization levels. Dense areas are characterized by higher \textbf{NO$_2$} concentrations, rural areas by elevated \textbf{O$_3$} livels linked to reduced NO titration, 
	...
	\textbf{Cluster 2} is the dirtiest group. Its primary-pollutant concentrations are the highest year-round, and in winter both PM$_{2.5}$ and NO$_2$ regularly breach guideline levels.

	\textbf{Cluster 0} sits near the regional average. \textbf{Cluster 1}, the lone municipality, has readings extreme enough to form its own cluster, confirming it is a statistical outlier.
	...
	\end{table}
	 ...
	 \textbf{Cluster 2} has the highest index (0.887), but that is driven by one municipality. \textbf{Cluster 0} comes next at 0.779, the dirtiest multi-municipality group. \textbf{Cluster 1} is well below at 0.471.
	...
	Three meteorological patterns emerge from the rules, each with its own pollution signature.
	...
	Features includes lagged traffic (1, 2, 3, and 7 days back), a 7-day rolling mean and standard deviation, day of week, month, a weekend flag, a holiday indicator, and a bridge-day indicator.
	...
	The features capture about 72\% of daily variance. The missing 28\% is presumably releated to other feature not mapped like weather, big public events, and transport strikes.
	...
	Holiday and bridge indicator were added to compensate but is not sufficent.
	...
	\begin{itemize}
		...
		\item drafting documentation, checking text end fixing grammar
	\end{itemize}
