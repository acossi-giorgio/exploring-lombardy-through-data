...
class Source(ABC):
	...
	This is \textbf{seasonal confounding}, low traffic and high ozone co-occur because August kills commuter traffic exactly when summer meteorology pushes O$_3$ up. This is a calendar effect, not a causal link.
